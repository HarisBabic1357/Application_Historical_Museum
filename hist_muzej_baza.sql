...
sifZap SMALLINT NOT NULL,
sifDog CHAR(15) NOT NULL,
FOREIGN KEY(sifZap) REFERENCES ZAPOSLENIK(sifZap),
FOREIGN KEY(sifDog) REFERENCES DOGAĐAJ(sifDog)
);
...
sifDog CHAR(15) NOT NULL,
FOREIGN KEY(sifEksp) REFERENCES EKSPONAT(sifEksp),
FOREIGN KEY(sifDog) REFERENCES DOGAĐAJ(sifDog)
...
INSERT INTO TIP_EKSPONAT VALUES('gr11','grafika');
 ...
 INSERT INTO DVORANA VALUES('1000','Medalje','Skup odlikovanja za različite doprinose u društvu','140', '210','2ab2');
 ...
 INSERT INTO DVORANA VALUES('1100','Zastave i pejzaži gradova','Skup različitih zastava kao simboli zemalja ','80', '40','7ag7');
...
INSERT INTO EKSPONAT VALUES('Eks08', 'Zastava Autonomne BiH', 'željezo', '200x140 cm','nv_40','1100','fl05');
...
INSERT INTO EKSPONAT VALUES('Eks11', 'Pejzaž', 'drvorez', '25x39 cm','nv_40','1100','gr10');

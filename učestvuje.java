...
public class uèestvuje {
	...
	public void table_load() {
		try
		{
			pst=conn.prepareStatement("select * from uèestvuje");
			rs=pst.executeQuery();
	...
	public void fillComboBox() {
		try {
			String query= "select * from zaposlenik,dogaðaj";
	...
	public static void main(String[]  args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					uèestvuje window = new uèestvuje ();
	...
	public  void showWindow() {
		 frame= new JFrame("UÈESNICI DOGAÐAJA");
		frame.setBounds(100,100,730,426);
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frame.getContentPane().setLayout(null);
		
		JButton btnNewButton_3 = new JButton("Ubaci uèesnika ");
		btnNewButton_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				
				String sql="INSERT INTO uèestvuje(sifZap, sifDog)VALUES(?,?)";
				try {
	...
	/*
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					pst=conn.prepareStatement("update uèestvuje set sifZap=? where sifDog=?");
		...
		*/
		...
		JButton btnNewButton_2 = new JButton("Izbriši uèesnika");
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String bid=comboBox.getSelectedItem().toString();
				try{
					pst=conn.prepareStatement("delete from uèestvuje where sifZap=?");
					pst.setString(1, bid);
					pst.executeUpdate();

...
public class Tip_Dogaðaj {
	...
	public void table_load() {
		try
		{
			pst=conn.prepareStatement("select * from tip_dogaðaj");
			rs=pst.executeQuery();
	...
	public static void main(String[]  args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Tip_Dogaðaj window = new Tip_Dogaðaj();
	...
	public  void showWindow() {
		 frame= new JFrame("TIP DOGAÐAJA");
		frame.setBounds(100,100,730,426);
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frame.getContentPane().setLayout(null);
		
		JButton btnNewButton_3 = new JButton("Ubaci tip dogaðaja");
		btnNewButton_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				
				String sql="INSERT INTO tip_dogaðaj(sifTipDog, nazTipDog)VALUES(?,?)";
				try {
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					pst=conn.prepareStatement("update tip_dogaðaj set nazTipDog=? where sifTipDog=?");
					pst.setString(1, naz);
					pst.setString(2, bid);
					pst.executeUpdate();
		...
		JButton btnNewButton_2 = new JButton("Izbriši tip dogaðaja");
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String bid=textsifTipDog.getText();
				try{
					pst=conn.prepareStatement("delete from tip_dogaðaj where sifTipDog=?");
					pst.setString(1, bid);
					pst.executeUpdate();
		...
		JLabel lblNewLabel = new JLabel("sifTipDogaðaj");
		...
		JLabel lblNewLabel_1 = new JLabel("nazivTipDogaðaj");
